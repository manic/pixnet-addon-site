...
ActiveRecord::Schema.define(:version => 20110323063821) do

  create_table "akismets", :force => true do |t|
    t.integer  "user_id"
    t.string   "apikey"
  ...
  add_index "akismets", ["user_id"], :name => "index_akismets_on_user_id"
  ...
  add_index "comments", ["user_id", "pixnet_comment_id"], :name => "index_comments_on_user_id_and_pixnet_comment_id", :unique => true
